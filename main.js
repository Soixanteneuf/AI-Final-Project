...
async function loadMobilenet() {
    const mobilenet = await tf.loadLayersModel('https://raw.githubusercontent.com/Soixanteneuf/tfjs-model-for-rps/main/models/model.json');
...
function generate() {
  ...
  `;
    ...
    async function onTimesUp() {
        ...
        document.getElementById("res").innerText = suitRes;
